        ...
        <div ref={ref} className="w-72 h-full sideCart absolute top-0 right-0 bg-pink-100 px-8 py-10 transform transition-transform translate-x-full">
          ...
          <ol className="list-decimal font-semibold">
            ...
            <li>
              ...
              <FaCircleMinus className="cursor-pointer text-pink-500" /> <span className="mx-2 text-sm">1</span> <FaCirclePlus className="cursor-pointer text-pink-500" />
          ...
          <button className=" cursor-pointer flex mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg"><IoBagCheckSharp className="m-1" />
           Checkout</button>
